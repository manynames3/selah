...
The original admin gate was client-side and unsuitable for protecting real create/delete operations. The application needs authenticated admin actions without exposing database or object-storage credentials in the browser.
...
- Database bindings, R2 bindings, and the admin password stay off the client.
